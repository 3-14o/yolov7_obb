...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                # Classification
                class_index = 5 + self.nc # TODO: it may not be 5
        ...
        return loss * bs, torch.cat((lbox, lobj, lcls, ltheta, loss)).detach() # TODO: check what uses it, cuz returning more params
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):
            ...
            gwh = t[:, 4:6]  # grid wh
            # theta = t[:, 6]
            gaussian_theta_labels = t[:, 7:-1] # TODO: may have changed
            gij = (gxy - offsets).long()
            gi, gj = gij.T  # grid xy indices

            # Append
            # a = t[:, 6].long()  # anchor indices
            a = t[:, -1].long()  # anchor indices 取整 # TODO: may have changed
...
class ComputeLossOTA:
    # Compute losses
    pass # TODO: change it to work with obb
    # def __init__(self, model, autobalance=False):
